...
echo "-------------git clone https://github.com/gitkovsky/XENGPUMiner_2023-10-20.git--------------"
git clone https://github.com/gitkovsky/XENGPUMiner_2023-10-20.git
sleep 1

echo "-------------cd XENGPUMiner--------------"
cd XENGPUMiner_2023-10-20
sleep 1
